  ...
  <div class="manager-container">
    ...
    <div class="manager-header">
      <div class="manager-header-left">
        ...
        <div class="title">平安镇产品信息发布资源共享平台</div>
      </div>
    ...
    <div class="manager-main">
      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user','stockManager','saleManager']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index ="saleManager">
            <template slot="title">
              <i class="el-icon-menu"></i><span>销售管理</span>
            </template>
            <el-menu-item index="/sale">批发订单信息</el-menu-item>
            <el-menu-item index="/saleBack">批发退货信息</el-menu-item>
  ...
  methods: {
    ...
    goToPerson() {
      if (this.user.role === 'ADMIN') {
        ...
        this.$router.push('/customerPerson')
      }
    },
    logout() {
