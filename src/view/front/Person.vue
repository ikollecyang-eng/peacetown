    ...
    <el-card style="width: 50%; margin: 30px auto">
      ...
      <el-form :model="user" label-width="80px" style="padding-right: 20px">
        ...
        <el-form-item label="联系人" prop="user">
          <el-input v-model="user.user" placeholder="联系人"></el-input>
        </el-form-item>
        <el-form-item label="客户电话" prop="tel">
          <el-input v-model="user.tel" placeholder="客户电话"></el-input>
        </el-form-item>
        <el-form-item label="开户银行" prop="bank">
          <el-input v-model="user.bank" placeholder="开户银行"></el-input>
        </el-form-item>
        <el-form-item label="开户账号" prop="bankCard">
          <el-input v-model="user.bankCard" placeholder="开户账号"></el-input>
        </el-form-item>
        <el-form-item label="邮编" prop="zipCode">
          <el-input v-model="user.zipCode" placeholder="邮编"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    update() {
      // 保存当前的用户信息到数据库
      this.$request.put('/customer/update', this.user).then(res => {
        if (res.code === '200') {
          // 成功更新
