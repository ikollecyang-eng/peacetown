<template>
  <div class="main-content">
    <div style="width: 80%; margin: 30px auto; border-radius: 20px">
...
<!--        <div style="width: 400px; margin: 0 20px 0 50px; font-size: 20px; font-weight: bold;">-->
<!--          <div style="height: 40px; line-height: 40px; margin-left: 10px">{{businessData.name}}</div>-->
<!--          <img src="@/assets/imgs/icon.png" alt="" style="height: 25px; margin-top: 50px">-->
<!--        </div>-->
        <div style="margin-left : 20px ">
          <el-descriptions title="商户信息" >
            <el-descriptions-item label="供应商" >{{businessData.name}}</el-descriptions-item>
            <el-descriptions-item label="手机号">{{businessData.phone}}</el-descriptions-item>
            <el-descriptions-item label="地址">{{businessData.address}}</el-descriptions-item>
            <el-descriptions-item label="联系人">
              {{businessData.user}}
            </el-descriptions-item>
            <el-descriptions-item label="邮箱">{{businessData.email}}</el-descriptions-item>
          </el-descriptions>
        </div>

<!--        <div style="width: 150px; height: 100px; padding: 20px">-->
<!--          <div style="font-size: 16px; height: 30px; line-height: 30px; color: #7F7F7FFF; margin-left: -30px">店铺电话</div>-->
<!--          <div style="font-size: 16px; height: 30px; line-height: 30px; margin-left: -50px">{{businessData.phone}}</div>-->
<!--        </div>-->
<!--        <div style="width: 150px; height: 100px; padding: 20px">-->
<!--          <div style="font-size: 16px; height: 30px; line-height: 30px; color: #7F7F7FFF">店铺邮箱</div>-->
<!--          <div style="font-size: 16px; height: 30px; line-height: 30px; margin-left: -50px">{{businessData.email}}</div>-->
<!--        </div>-->
...
<!--        </div>-->
      ...
      <div style="border-radius: 20px; padding: 0 20px; background-color: white; margin-top: 5px">
...
export default {
  ...
  methods: {
    loadBusiness() {
      this.$request.get('/supplier/selectById/' + this.businessId).then(res => {
        if (res.code === '200') {
