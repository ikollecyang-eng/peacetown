...
public class TokenUtils {
    ...
    private static CustomerService staticCustomerService;
    @Resource
    ...
    public void setUserService() {
        ...
        staticCustomerService = customerService;
    }
    ...
    public static Account getCurrentUser() {
        try {
            ...
            if (ObjectUtil.isNotEmpty(token)) {
                ...
                }else if(RoleEnum.CUSTOMER.name().equals(role))
                {
                    return staticCustomerService.selectById(Integer.valueOf(userId));
                }
            }
        } catch (Exception e) {
